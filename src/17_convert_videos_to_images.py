        ...
        for frame_idx in range(v):
            ...
            for idx in range(len(labels[k]['left'])):
                if (
                    ...
                    left_mapped_height = int((int(labels[k]['left'][idx]['y']) * image_size) / 100)
                    label_row["left"] = left_mapped_height
                    break
            ...
            for idx in range(len(labels[k]['center'])):
                if (
                    ...
                    left_mapped_height = int((int(labels[k]['center'][idx]['y']) * image_size) / 100)
                    label_row["center"] = left_mapped_height
                    break
            ...
            for idx in range(len(labels[k]['right'])):
                if (
                    ...
                    left_mapped_height = int((int(labels[k]['right'][idx]['y']) * image_size) / 100)
                    label_row["right"] = left_mapped_height
                    break
